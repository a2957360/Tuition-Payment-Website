<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO `house_table`(`Method`, `CompanyName`, `CompanyAbb`, `CompanyAddress`, `AccountNo`, `Memo`, `Price`, `ChargeFee`, `Reference`, `UserId`, `Status`, `Date`) VALUES ('$method','$companyname','$compannyabb','$address','$accountno','$memo','$price','$charge','$referenceno','$Id','0','$todaydate')");
    $stmt->execute();
      if($stmt != null){
        ...
        if($stmt != null){
          while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            echo "<script> location.href='housepayment.php'; </script>";
          }
        }
      }else{
...
<html lang="en">
  <head>
    ...
    <title>AliCanada Rent Fee</title>
  </head>
...
<!--             <div class="col-12  ud20">
      ...
      <div class="row footer text-center ">
        <div class="col-12 m-auto">
          <p>@ 2019 Finstudio. All rights reserved.</p>
        </div>
      </div>
    </div>
