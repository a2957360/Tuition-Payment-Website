<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("UPDATE `house_table` SET `FirstName`='$firstname',`LastName`='$lastname',`Phone`='$phone',`Email`='$email',`OrderNo`='$orderid' WHERE `Id`='$paymentId';");
    $stmt->execute();
      if($stmt != null){
          echo "<script> location.href='houseconfirm.php'; </script>";
