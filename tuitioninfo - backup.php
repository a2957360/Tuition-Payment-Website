<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO `student_table`(`Method`, `SchoolName`, `SchoolAddress`, `StudentNo`, `Price`, `ChargeFee`, `Reference`, `UserId`, `Status`, `Date`) VALUES ('$method','$schoolname','$address','$studentno','$price','$charge','$referenceno','$Id','0','$todaydate')");
    $stmt->execute();
      if($stmt != null){
...
<!--             <div class="col-12  ud20">
              <div class="row">
                <label class="col-8 col-lg-4">
                  <input type="radio" name="method" value="ALIPAY" checked="">
                  <img class=" payicon img-fluid m-auto" alt="Responsive image"  src="static/img/alipaymethod.png">
                </label>
                <label class="col-8 col-lg-4">
                  <input type="radio" name="method" value="WECHATPAY">
                  <img class=" payicon img-fluid m-auto" alt="Responsive image"  src="static/img/wechatmethod.png">
                </label>
                <label class="col-8 col-lg-4">
                  <input type="radio" name="method" value="UNIONPAY">
                  <img class=" payicon img-fluid m-auto" alt="Responsive image"  src="static/img/yinliangmethod.png">
                </label>
              </div>
            </div> -->
            ...
            <div class="col-12 ">
              <p><span class="colorred">*</span>学校名称（拼音）:</p>
              <input class="wide-80" pattern="[a-zA-Z0-9 ]{0,50}" type="text" name="schoolname" required autofocus>
            </div>
            <div class="col-12 ">
              <p><span class="colorred">*</span>学校地址（拼音）:</p>
              <input class="wide-80"  type="text" name="address" required>
            </div>
            <div class="col-12 ">
              <p>Student Number</p>
              <input class="wide-80"  type="text" name="studentno">
            </div>    
