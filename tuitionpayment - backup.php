<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("UPDATE `student_table` SET  `StudentFirstName`='$sfirstname',`StudentLastName`='$slastname',`Birthday`='$birthday',`FirstName`='$firstname',`LastName`='$lastname',`Phone`='$phone',`Email`='$email',`OrderNo`='$orderid' WHERE `Id`='$paymentId';");
    $stmt->execute();
      if($stmt != null){
